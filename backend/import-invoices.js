...
const toInvoiceDefaults = (fileName, index) => {
...
const importInvoices = async () => {
    ...
    for (const [i, fileName] of invoiceFiles.entries()) {
        ...
        await schemas_1.TransactionModel.updateOne({ invoiceNumber: fileName }, { $set: doc }, { upsert: true });
        upsertedCount += 1;
...
exports.default = importInvoices;
