...
router.get('/recent', async (req, res) => {
    try {
        const recentTransactions = (await (0, dynamoRepository_1.listTransactions)()).slice(0, 10);
        res.json({
            success: true,
...
router.post('/', upload.array('supportingDocuments', 20), async (req, res) => {
    try {
        ...
        const supplierEntity = await (0, dynamoRepository_1.getEntityById)(String(transactionData.supplierId || ''));
        const buyerEntity = await (0, dynamoRepository_1.getEntityById)(String(transactionData.buyerId || ''));
        ...
        const savedTransaction = await (0, dynamoRepository_1.createTransaction)(newTransaction);
        ...
        await (0, dynamoRepository_1.updateEntity)(supplierEntity.entityId, {
        ...
        await (0, dynamoRepository_1.updateEntity)(buyerEntity.entityId, {
...
router.delete('/:id', async (req, res) => {
    try {
        ...
        const transactionToDelete = await (0, dynamoRepository_1.getTransactionById)(id);
        ...
        const deletedTransaction = await (0, dynamoRepository_1.deleteTransaction)(transactionToDelete.transactionId);
        ...
        const supplierEntity = await (0, dynamoRepository_1.getEntityById)(String(transactionToDelete.supplierId || ''));
        const buyerEntity = await (0, dynamoRepository_1.getEntityById)(String(transactionToDelete.buyerId || ''));
